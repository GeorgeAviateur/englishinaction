...
function envia(rotelo) {
	...
	if (rotelo === 1) {
		...
		setTimeout(function () {
			window.location = "videos/cinema/cinemapast.html?" + rotelo;
		}, 1000);
	} else if (rotelo === 2) {
		if (cadVariables === '11' || cadVariables === '21' || cadVariables === '31' || cadVariables === '41') {
			rotelo = '21';
		...
		setTimeout(function () {
			window.location = "videos/bar/barpast.html?" + rotelo;
		}, 1000);
	} else if (rotelo == 3) {
		if (cadVariables == '11' || cadVariables == '21' || cadVariables == '31' || cadVariables == '41') {
			rotelo = '31';
		...
		setTimeout(function () {
			window.location = "videos/gym/gympast.html?" + rotelo;
		}, 1000);
	} else if (rotelo == 4) {
		if (cadVariables == '11' || cadVariables == '21' || cadVariables == '31' || cadVariables == '41') {
			rotelo = '41';
		...
		setTimeout(function () {
			window.location = "videos/food/foodpast.html?" + rotelo;
		}, 1000);
	} else if (rotelo == 5) {
		if (cadVariables == '11' || cadVariables == '21' || cadVariables == '31' || cadVariables == '41') {
			window.location = "videos/know/knowpast.html?" + cadVariables;
		}
		if (cadVariables != '11' || cadVariables != '21' || cadVariables != '31' || cadVariables != '41') {
			window.location = "videos/know/knowpast.html?5";
		}
	}
}
...
function whichButton(event) {
	...
	} else if (event.keyCode == '39' && x >= myWidth - (ciclaWidth + 38) && xback < 500) {
		xback += 2;
		xtit -= 10;
		xcredit -= 1;
		$("#canvasContainer").css('background-position', xback + '% 100%');
