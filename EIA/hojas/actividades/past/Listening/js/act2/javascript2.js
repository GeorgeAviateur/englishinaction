...
function capturar(NUMBER){
	...
	if(NUMBER==4){
		...
		if(traecarlos1=="talked to friends"){
			cuentabien++;
	...
	if(NUMBER==5){
		...
		if(traecarlos1=="took a yoga class"){
			cuentabien++;
	...
	if(NUMBER==6){
		...
		if(traecarlos1=="watched drama films"){
			cuentabien++;
	...
	if(NUMBER==7){
		...
		if(traecarlos1=="watched adventure films"){
			cuentabien++;
	...
	if(NUMBER==8){
		...
		if(traecarlos1=="took a step class"){
			cuentabien++;
