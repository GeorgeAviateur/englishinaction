...
if (ejliste[7]==1){ 	
if(((respuestiña=="exercised")||(respuestiña=="Exercised")||(respuestiña=="EXERCISED"))&&(contadorsiño==0)){
...
document.getElementById('parrafiño2').innerHTML="Exercised."; 
$('#reproducir00').css('opacity','1');
activar[7] = 1;
...
if(((respuestiña=="ate_fast_food")||(respuestiña=="ATE_FAST_FOOD")||(respuestiña=="Ate_fast_food"))&&(contadorsiño==0)){
tucha++;
$('#input2').css('border','3px solid #308c58');
document.getElementById('aplausos').play();
$('#input2').css('pointer-events','none'); 
...
setTimeout(function(){
$('#formulario').css('display','none');
document.getElementById('parrafiño2').innerHTML="Ate Fast Food."; 
$('#reproducir00').css('opacity','1');
//activar[13] = 1; 
activar[8] = 1;
...
if (ejliste[9]==1){ 	
if(((respuestiña=="drank_beer")||(respuestiña=="Drank_beer")||(respuestiña=="DRANK_BEER"))&&(contadorsiño==0)){
...
setTimeout(function(){
$('#formulario').css('display','none');
document.getElementById('parrafiño2').innerHTML="Drank beer."; 
$('#reproducir00').css('opacity','1');
//activar[14] = 1; 
activar[9] = 1;
...
//-------------------------------------------------------------------------------------------------------------------------------------
if (ejliste[10]==1){ 	
if(((respuestiña=="talked_to_friends")||(respuestiña=="TALKED_TO_FRIENDS")||(respuestiña=="Talked_to_friends"))&&(contadorsiño==0)){
...
setTimeout(function(){
$('#formulario').css('display','none');
document.getElementById('parrafiño2').innerHTML="Talked to friends."; 
$('#reproducir00').css('opacity','1');
//activar[15] = 1; 
activar[10] = 1;
...
//-------------------------------------------------------------------------------------------------------------------------------------
if (ejliste[11]==1){ 	
if(((respuestiña=="took_a_yoga_class")||(respuestiña=="TOOK_A_YOGA_CLASS")||(respuestiña=="Took_a_yoga_class"))&&(contadorsiño==0)){
...
setTimeout(function(){
$('#formulario').css('display','none');
document.getElementById('parrafiño2').innerHTML="Took a yoga class"; 
$('#reproducir00').css('opacity','1');
//activar[16] = 1; 
bart2 = 1;
activar[11] = 1;
...
if (ejliste[12]==1){ 	
if(((respuestiña=="watched_drama_films")||(respuestiña=="WATCHED_DRAMA_FILMS")||(respuestiña=="Watched_drama_films"))&&(contadorsiño==0)){
tucha++;
$('#input2').css('border','3px solid #308c58');
document.getElementById('aplausos').play();
$('#input2').css('pointer-events','none'); 
...
setTimeout(function(){
$('#formulario').css('display','none');
document.getElementById('parrafiño2').innerHTML="Watched drama films."; 
$('#reproducir00').css('opacity','1');
activar[12] = 1;
document.getElementById('reproducir00').click(); 
$('#reproducir00').css('pointer-events','auto');
...
if (ejliste[13]==1){ 	
if(((respuestiña=="watched_adventure_films")||(respuestiña=="WATCHED_ADVENTURE_FILMS")||(respuestiña=="Watched_adventure_films"))&&(contadorsiño==0)){
...
setTimeout(function(){
$('#formulario').css('display','none');
document.getElementById('parrafiño2').innerHTML="Watched adventure films."; 
$('#reproducir00').css('opacity','1');
//activar[18] = 1;
activar[13] = 1; 
document.getElementById('reproducir00').click(); 
...
if (ejliste[14]==1){ 	
if(((respuestiña=="took_a_step_class")||(respuestiña=="Took_a_step_class")||(respuestiña=="TOOK_A_STEP_CLASS"))&&(contadorsiño==0)){
tucha++;
$('#input2').css('border','3px solid #308c58');
document.getElementById('aplausos').play();
$('#input2').css('pointer-events','none'); 
...
setTimeout(function(){
document.getElementById('parrafiño1').innerHTML="<b>Took a step class.</b>"; 
$('#reproducir00').css('opacity','1');
activar[14] = 1;
document.getElementById('reproducir00').click(); 
$('#reproducir00').css('pointer-events','auto');
...
if (ejliste[15]==1){ 	
if(((respuestiña=="danced")||(respuestiña=="Danced")||(respuestiña=="DANCED"))&&(contadorsiño==0)){
tucha++;
$('#input2').css('border','3px solid #308c58');
document.getElementById('aplausos').play();
$('#input2').css('pointer-events','none'); 
...
if(((respuestiña=="What_did_you_do_last_night")||(respuestiña=="what_did_you_do_last_night")||(respuestiña=="WHAT_DID_YOU_DO_LAST_NIGHT")) && indice==3 &&(contadorsiño==0)){
tucha++;
$('#input2').css('border','3px solid #308c58');
document.getElementById('aplausos').play();
$('#input2').css('pointer-events','none'); 
...
document.getElementById('parrafiño2').innerHTML="What did you do last night? <br>- I watched tv."; 
$('#reproducir00').css('opacity','1');
activar[16] = 1;
document.getElementById('reproducir00').click(); 
$('#reproducir00').css('pointer-events','auto');
...
if (ejliste[17]==1){ 	
	indice=document.getElementById("cuadro1").selectedIndex;
if(((respuestiña=="Where_were_you_born")||(respuestiña=="where_were_you_born")||(respuestiña=="WHERE_WERE_YOU_BORN")) && indice==2 &&(contadorsiño==0)){
tucha++;
$('#input2').css('border','3px solid #308c58');
document.getElementById('aplausos').play();
$('#input2').css('pointer-events','none'); 
...
document.getElementById('parrafiño2').innerHTML="Where were you born?<br>- I was born in Naples, Florida (USA)"; 
$('#reproducir00').css('opacity','1');
activar[17] = 1;
document.getElementById('reproducir00').click(); 
$('#reproducir00').css('pointer-events','auto');
...
if (ejliste[18]==1){ 	
indice=document.getElementById("cuadro1").selectedIndex;
if(((respuestiña=="What_did_you_eat_last_night")||(respuestiña=="what_did_you_eat_last_night")||(respuestiña=="WHAT_DID_YOU_EAT_LAST_NIGHT")) && indice==4 &&(contadorsiño==0)){
tucha++;
$('#input2').css('border','3px solid #308c58');
document.getElementById('aplausos').play();
$('#input2').css('pointer-events','none'); 
...
document.getElementById('parrafiño2').innerHTML="What did you eat last night?<br>- I ate a hot dog"; 
$('#reproducir00').css('opacity','1');
activar[18] = 1;
document.getElementById('reproducir00').click(); 
$('#reproducir00').css('pointer-events','auto');
...
indice=document.getElementById("cuadro1").selectedIndex;
if(((respuestiña=="What_was_your_favorite_food_when_you_were_a_child")||(respuestiña=="what_was_your_favorite_food_when_you_were_a_child")||(respuestiña=="WHAT_WAS_YOUR_FAVORITE_FOOD_WHEN_YOU_WERE_A_CHILD")) && indice==0 &&(contadorsiño==0)){
tucha++;
$('#input2').css('border','3px solid #308c58');
document.getElementById('aplausos').play();
$('#input2').css('pointer-events','none'); 
...
document.getElementById('parrafiño2').innerHTML="What was your favorite food when you were a child?<br>- My favorite food was lasagna"; 
$('#reproducir00').css('opacity','1');
activar[19] = 1;
document.getElementById('reproducir00').click(); 
$('#reproducir00').css('pointer-events','auto');
...
if (ejliste[20]==1){ 	
indice=document.getElementById("cuadro1").selectedIndex;
if(((respuestiña=="Were_you_at_home_last_weekend")||(respuestiña=="were_you_at_home_last_weekend")||(respuestiña=="WERE_YOU_AT_HOME_LAST_WEEKEND")) && indice==1 &&(contadorsiño==0)){
tucha++;
$('#input2').css('border','3px solid #308c58');
document.getElementById('aplausos').play();
$('#input2').css('pointer-events','none'); 
...
document.getElementById('parrafiño2').innerHTML="Were you at home last weekend?<br>- No, I was in Bogota"; 
$('#reproducir00').css('opacity','1');
activar[20] = 1;
document.getElementById('reproducir00').click(); 
$('#reproducir00').css('pointer-events','auto');
