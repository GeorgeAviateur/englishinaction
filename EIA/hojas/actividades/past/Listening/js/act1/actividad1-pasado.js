$(document).ready(function() {
    ...
    if(controlRespuesta==1){
        ...
        document.getElementById('audio1').play(); },3100);
        }
...
function diceAudio(){auto=setTimeout(function(){
    ...
    document.getElementById('resultado1').innerHTML='Manuel and Rose went to the movies.';
    document.getElementById('audio7').play();},1100);

auto=setTimeout(    
        function(){  
            document.getElementById('resultado1').innerHTML='Laura listened to music.';    
document.getElementById('audio5').play();  $("#next").click();

},4100   );

auto=setTimeout(    function(){$("#next").click();document.getElementById('resultado1').innerHTML='They danced at the disco last Saturday.'; 
document.getElementById('audio1').play();    },5900 );

auto=setTimeout(    function(){$("#next").click();document.getElementById('resultado1').innerHTML='Tina did aerobics.'; 
document.getElementById('audio6').play();  },9220   );

auto=setTimeout(function(){$("#next").click();document.getElementById('resultado1').innerHTML='Carlos and Ana drank cocktails.'; 
document.getElementById('audio2').play(); },11100);

auto=setTimeout(function(){$("#next").click();document.getElementById('resultado1').innerHTML='Lili Drank beer last weekend.'
    document.getElementById('audio3').play();;},14100);

auto=setTimeout(function(){$("#next").click();document.getElementById('resultado1').innerHTML='They did yoga at the gym this morning.'
    document.getElementById('audio4').play();;},17000);
auto=setTimeout(function(){
