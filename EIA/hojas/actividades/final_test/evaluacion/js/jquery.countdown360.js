;(function ($, window, document, undefined) {
  var pluginName = "countdown360",
    defaults = {
      ...
      strokeStyle: "#8ac575",          // the color of the stroke
      strokeWidth: 10,          // the stroke width, dynamically calulated if omitted in options
      fillStyle: "#477050",            // the fill color
      fontColor: "#8ac575",            // the font color
  ...
  Plugin.prototype = { 
    ...
    _drawCountdownLabel: function (secondsElapsed) { 
      ...
      }   if(secondsLeft==0) {document.getElementById('continuar').onclick(); document.getElementById('continuar11').onclick(); document.getElementById('continuar33').onclick(); document.getElementById('continuar22').onclick(); } // yujuuuuuuuuuuuuuu
    },
