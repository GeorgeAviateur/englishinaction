...
if (botoncito=="e1"){
	...
	if ((a1 == "what_did_you_do_last_night"&& indice==3)) {
			//alert("muy bien1");
...
if (botoncito=="e2"){
	...
	if ((a2=="where_were_you_born" && indice==2)) {
			//alert("muy bien2");
			document.getElementById('bien').play();
			$('#'+a2).css('opacity','0.6');
...
if (botoncito=="e3"){
	...
	if ((a3=="what_did_you_eat_last_night" && indice==4)) {
		//alert("muy bien3");
		document.getElementById('bien').play();
		$('#'+a3).css('opacity','0.6');
...
if (botoncito=="e4"){
	...
	if ((a4=="what_was_your_favorite_food_when_you_were_a_child" && indice==0)) {
		//alert("muy bien4");
		document.getElementById('bien').play();
		...
		if ((aux>2)&&((a4!="what_was_your_favorite_food_when_you_were_a_child"))){
			//alert("You've exhausted your attempts");
			$(form1.does_your_mother_like_cooking_pasta).css('pointer-events','none'); 
...
if (botoncito=="e5"){
	...
	if ((a5=="were_you_at_home_last_weekend" && indice==1)) {
		//alert("muy bien5");
		 $('#siguien').css('display','inline');
		...
		if ((aux>2)&&(a5!="were_you_at_home_last_weekend")){
			//alert("You've exhausted your attempts");
			$(form1.what_do_you_usually_do_in_your_free_time).css('pointer-events','none'); 
