...
/*document.getElementById('mostra1').innerHTML='<b>Answer: Rose had one month of vacation.</b>';
document.getElementById('mostra2').innerHTML="<b>Answer: Rose went to Cartagena with her family.</b>";
document.getElementById('mostra3').innerHTML="<b>Answer: Rose and her family visited "San Felipe Castle" and "the walled city or ciudad Amurallada".</b>";
document.getElementById('mostra4').innerHTML="<b>Answer: Rose went to bars at night.</b>";
document.getElementById('mostra5').innerHTML="<b>Answer: Rose and her brother ate fast food.</b>";*/
auto=setTimeout(function(){ $('input').css('display','none');$('.viki').css('display','inline'); document.getElementById('a1').play(); },3500);
auto=setTimeout(function(){ document.getElementById('a2').play(); },9000);
auto=setTimeout(function(){ document.getElementById('a3').play();},13000);
auto=setTimeout(function(){ document.getElementById('a4').play();},24000);
