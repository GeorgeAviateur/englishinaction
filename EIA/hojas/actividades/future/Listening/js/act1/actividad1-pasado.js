...
function diceAudio(){
    ...
    document.getElementById('resultado1').innerHTML='We are going to watch a movie on Saturday.';
    document.getElementById('audio7').play();},1100);

auto=setTimeout(    
        function(){  
            document.getElementById('resultado1').innerHTML='Manuel is going to sunbathe at the beach next weekend.';    
document.getElementById('audio5').play();  $("#next").click();

},4400   );

auto=setTimeout(    function(){
   $("#next").click();document.getElementById('resultado1').innerHTML='Laura is going to dance with her friends on Friday night.'; 
document.getElementById('audio1').play();    },8010 );

auto=setTimeout(    function(){
    $("#next").click();document.getElementById('resultado1').innerHTML='I’m going to travel to Barranquilla on my next vacation.'; 
document.getElementById('audio6').play();  },12120   );

auto=setTimeout(function(){
   $("#next").click();document.getElementById('resultado1').innerHTML='Charlie is going to the gym tomorrow.'; 
document.getElementById('audio2').play(); },16500);

auto=setTimeout(function(){
 $("#next").click();document.getElementById('resultado1').innerHTML='Sussy is going to drink some beers tonight.'
    document.getElementById('audio3').play();;},20100);

auto=setTimeout(function(){
 $("#next").click();document.getElementById('resultado1').innerHTML='Sue is going to relax in a yoga class.'
    document.getElementById('audio4').play();;},24000);
auto=setTimeout(function(){
