...
/*document.getElementById('mostra1').innerHTML='<b>Answer: Rita is eighteen years old.</b>';
document.getElementById('mostra2').innerHTML="<b>Answer: Rita lives in Israel.</b>";
document.getElementById('mostra3').innerHTML="<b>Answer: She likes to dance salsa.</b>";
document.getElementById('mostra4').innerHTML="<b>Answer: She doesn't like ballet.</b>";
document.getElementById('mostra5').innerHTML="<b>Answer: Rita doesn't have time to do her homework.</b>";
document.getElementById('mostra6').innerHTML="<b>Answer: The money they collect from the salsa show is to help sick children. </b>";
*/
...
auto=setTimeout(function(){ document.getElementById('a4').play();},20000);
auto=setTimeout(function(){ document.getElementById('a5').play();},25000);
auto=setTimeout(function(){ document.getElementById('a6').play();},31000);
