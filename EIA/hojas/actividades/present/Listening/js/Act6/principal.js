...
if (botoncito=="e1"){
	...
	if ((a1 == "what_is_your_favorite_food"&& indice==3)) {
			//alert("muy bien1");
			...
			if ((aux>2)&&(a1!="what_is_your_favorite_food") && (indice!=3)){
...
if (botoncito=="e2"){
	...
	if ((a2=="do_you_like_going_to_the_gym" && indice==2)) {
			//alert("muy bien2");
			document.getElementById('bien').play();
			$('#'+a2).css('opacity','0.6');
			...
			if ((aux>2)&&(a2!="do_you_like_going_to_the_gym")){
				//alert("You've exhausted your attempts");
				$(form1.do_you_like_going_to_the_gym).css('pointer-events','none'); 
...
if (botoncito=="e3"){
	...
	if ((a3=="why_do_you_like_science_fiction_films" && indice==4)) {
		//alert("muy bien3");
		document.getElementById('bien').play();
		$('#'+a3).css('opacity','0.6');
		...
		if ((aux>2)&&(a4!="why_do_you_like_science_fiction_films?")){
			//alert("You've exhausted your attempts");
			$(form1.why_do_you_like_science_fiction_films).css('pointer-events','none'); 
...
if (botoncito=="e4"){
	...
	if ((a4=="does_your_mother_like_cooking_pasta" && indice==0)) {
		//alert("muy bien4");
		document.getElementById('bien').play();
		...
		if ((aux>2)&&((a4!="does_your_mother_like_cooking_pasta"))){
			//alert("You've exhausted your attempts");
			$(form1.does_your_mother_like_cooking_pasta).css('pointer-events','none'); 
...
if (botoncito=="e5"){
	...
	if ((a5=="what_do_you_usually_do_in_your_free_time" && indice==1)) {
		//alert("muy bien5");
		document.getElementById('bien').play();
 			$('#siguien').css('display','inline');
		...
		if ((aux>2)&&(a5!="what_do_you_usually_do_in_your_free_time")){
			//alert("You've exhausted your attempts");
			$(form1.what_do_you_usually_do_in_your_free_time).css('pointer-events','none'); 
