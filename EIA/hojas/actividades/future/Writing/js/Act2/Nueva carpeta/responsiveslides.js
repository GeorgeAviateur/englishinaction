...
$('#featured1').css('margin-top','2%');
$('#featured1').css('margin-bottom','4%');
...
$('.perendengues').css('display','none'); 
if(mm!=0){audio.pause();audio.currentTime = 0;}
//},0000);

//auto=setTimeout(function(){ 
document.getElementById('L').play();  
for (i=0;i<4;i++){ activar[i] = 0;}; 
$('.elnav').css('display','none'); 
//},0000);
...
/*document.getElementById('titulito1').innerHTML='<b>People will live on the moon in the future.</b>';
document.getElementById('titulito2').innerHTML="<b>Robots won't replace humans.</b>";
document.getElementById('titulito3').innerHTML="<b>What are you going to do next weekend?</b>";
document.getElementById('titulito4').innerHTML="<b>Sam is going to buy a car next year.</b>";
document.getElementById('titulito5').innerHTML="<b>There won't be enough water in fifty years.</b>";*/

auto=setTimeout(function(){ $('.lostitulitos').css('visibility','visible');document.getElementById('a1').play();},1500);
...
auto=setTimeout(function(){  $('.sig2').css('display','none'); $('#continuarw2').css('display','inline'); document.getElementById('continuarw2').click();},25000);
}
//--------------------------------------------------------------------------------------------------------------
function finalizaw2(){
/*$('.perendengues').css('display','none');
