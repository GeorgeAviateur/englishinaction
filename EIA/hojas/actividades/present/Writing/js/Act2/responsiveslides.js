...
$('#featured1').css('margin-top','3%');
$('#featured1').css('margin-bottom','5%');
...
/*document.getElementById('titulito1').innerHTML='<b>Rachel likes eating fast food.</b>';
document.getElementById('titulito2').innerHTML="<b>We don't like dancing bachata.</b>";
document.getElementById('titulito3').innerHTML="<b>What kind of music do you like?</b>";
document.getElementById('titulito4').innerHTML="<b>Mike loves listening to rock music.</b>";
document.getElementById('titulito5').innerHTML="<b>Monica hates working out at the gym.</b>";*/
