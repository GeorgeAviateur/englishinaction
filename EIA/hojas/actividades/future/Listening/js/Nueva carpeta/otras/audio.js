$("document").ready(function(){
	...
	$("#audio1 #reproducir").click(function(){
		...
		if(controlAudio>3){
			alert("no more opportunities!");
			$("#reproducir").css('display','none');
			document.getElementById("continuar").click();
		}else
		{
		alert("You get "+(3-controlAudio)+" chances to hear the audio again");
	...
	$("#audio2 #reproducir").click(function(){
		...
		{
		alert("You get "+(3-ctrl2)+" chances to hear the audio again");
		...
		{
		alert("You get "+(3-ctrl3)+" chances to hear the audio again");
