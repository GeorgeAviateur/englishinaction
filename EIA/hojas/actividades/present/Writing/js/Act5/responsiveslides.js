...
/*document.getElementById('mostra1').innerHTML='<b>What food do you like to eat?</b>';
document.getElementById('mostra2').innerHTML="<b>What drink does she like?</b>";
document.getElementById('mostra3').innerHTML="<b>When does he usually go to the movies?</b>";
document.getElementById('mostra4').innerHTML="<b>Why doesn't he like horror movies?";
document.getElementById('mostra5').innerHTML="<b>What kind of music do they enjoy dancing?</b>";*/
auto=setTimeout(function(){ $('input').css('display','none'); $('.viki').css('display','inline'); $('h1').css('visibility','visible'); $('h1').css('text-align','center'); document.getElementById('ea1').play(); },1500);
auto=setTimeout(function(){ document.getElementById('eb1').play(); },7000);
auto=setTimeout(function(){ document.getElementById('a3').play();},13000);
auto=setTimeout(function(){ document.getElementById('a4').play();},19000);
auto=setTimeout(function(){ document.getElementById('a5').play();},25000);
auto=setTimeout(function(){$('.sig2').css('display','none');finalizaw5(5);},30000);
}
//--------------------------------------------------------------------------------------------------------------
function finalizaw5(){
