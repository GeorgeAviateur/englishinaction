...
/*document.getElementById('mostra1').innerHTML='<b>What are you going to do tomorrow?</b>';
document.getElementById('mostra2').innerHTML="<b>Where are you going to travel next vacation?</b>";
document.getElementById('mostra3').innerHTML="<b>Are you going to the party tonight?</b>";
document.getElementById('mostra4').innerHTML="<b>What is Jenny going to do to lose weight?</b>";
document.getElementById('mostra5').innerHTML="<b>Is Marco going to the movies tonight?</b>";*/
auto=setTimeout(function(){ $('input').css('display','none');$('.viki').css('display','inline');document.getElementById('a1').play(); },1000);
auto=setTimeout(function(){ document.getElementById('a2').play(); },7000);
