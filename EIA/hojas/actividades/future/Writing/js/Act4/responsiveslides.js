...
/*document.getElementById('mostra1').innerHTML='<b>Answer: Richard and Jenny are going on holiday to Hawaii.</b>';
document.getElementById('mostra2').innerHTML="<b>Answer: Richard and Jenny are going to stay at a hotel next to the beach.</b>";
document.getElementById('mostra3').innerHTML="<b>Answer: Jenny is going to work at a bar in summer.</b>";
document.getElementById('mostra4').innerHTML="<b>Answer: Jenny is going to join a gym to lose weight.</b>";
document.getElementById('mostra5').innerHTML="<b>Answer: Jenny is going to celebrate Richard’s birthday on 16th August.</b>";*/
